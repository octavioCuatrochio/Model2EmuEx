...
| 6 | sound | One sound board per instance. | Musashi is one global 68000, so each sound board keeps its own saved CPU context and switches to it (`m2snd.c`). The two boards are mixed at 3/4 each. |
